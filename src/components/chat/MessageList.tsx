...
export function MessageList({ messages, isLoading }: MessageListProps) {
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center px-4 text-center pt-8">
        ...
        <p className="text-[navy] text-sm max-w-sm">I can help you create buttons, forms, cards, and more</p>
      </div>
    );
  }
